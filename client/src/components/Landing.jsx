...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 text-center bg-[#06060a]">
      <div className="max-w-md w-full">
        <div className="inline-block px-4 py-1.5 rounded-full border border-white/10 text-[10px] tracking-[0.2em] uppercase text-zinc-400 mb-8">
        ...
        <a
          ...
          className="mt-10 inline-flex items-center gap-3 bg-white text-zinc-900 font-semibold px-8 py-4 rounded-2xl hover:bg-zinc-100 transition"
        >
          <GoogleIcon />
          Sign in with Google
        </a>
